...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/agrocrypto-worker-ai)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/agrocrypto-worker-ai
```

A live public deployment of this template is available at [https://agrocrypto-worker-ai.templates.workers.dev](https://agrocrypto-worker-ai.templates.workers.dev)
